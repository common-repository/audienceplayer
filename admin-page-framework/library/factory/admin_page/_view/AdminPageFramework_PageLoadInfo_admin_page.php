...
class AudiencePlayer_AdminPageFramework_PageLoadInfo_admin_page extends AudiencePlayer_AdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new AudiencePlayer_AdminPageFramework_PageLoadInfo_admin_page($oProp, $oMsg);
        return self::$_oInstance;
    }
