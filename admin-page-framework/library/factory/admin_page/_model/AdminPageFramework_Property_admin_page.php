...
class AudiencePlayer_AdminPageFramework_Property_admin_page extends AudiencePlayer_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'audienceplayer') {
        ...
        $GLOBALS['aAudiencePlayer_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aAudiencePlayer_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aAudiencePlayer_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
