...
class AudiencePlayer_AdminPageFramework_Model__FormSubmission__Validator_Base extends AudiencePlayer_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    ...
    class AudiencePlayer_AdminPageFramework_Model__FormSubmission__Validator extends AudiencePlayer_AdminPageFramework_Model__FormSubmission__Validator_Base {
        public $oFactory;
        ...
        public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
            ...
            $_aClassNames = array('AudiencePlayer_AdminPageFramework_Model__FormSubmission__Validator__Link', 'AudiencePlayer_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'AudiencePlayer_AdminPageFramework_Model__FormSubmission__Validator__Import', 'AudiencePlayer_AdminPageFramework_Model__FormSubmission__Validator__Export', 'AudiencePlayer_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'AudiencePlayer_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'AudiencePlayer_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'AudiencePlayer_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
            ...
            try {
                ...
                $_oFormSubmissionFilter = new AudiencePlayer_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
