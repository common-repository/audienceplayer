...
abstract class AudiencePlayer_AdminPageFramework_Model__FormSubmission_Base extends AudiencePlayer_AdminPageFramework_Form_Utility {
    ...
    class AudiencePlayer_AdminPageFramework_Model__FormSubmission extends AudiencePlayer_AdminPageFramework_Model__FormSubmission_Base {
        public $oFactory;
        public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            $this->oFactory = $oFactory;
            $this->_handleFormData();
            new AudiencePlayer_AdminPageFramework_Model__FormRedirectHandler($oFactory);
        }
        public function _handleFormData() {
            ...
            new AudiencePlayer_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
