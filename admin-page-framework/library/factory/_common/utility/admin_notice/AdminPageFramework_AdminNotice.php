...
class AudiencePlayer_AdminPageFramework_AdminNotice extends AudiencePlayer_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'audienceplayer-settings-notice-message', 'audienceplayer-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new AudiencePlayer_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
