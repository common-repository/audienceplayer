...
class AudiencePlayer_AdminPageFramework_AdminNotice___Script extends AudiencePlayer_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.audienceplayer-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='audienceplayer-admin-notice-animation-container'></div>" );
