...
abstract class AudiencePlayer_AdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        AudiencePlayer_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return AudiencePlayer_AdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        AudiencePlayer_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return AudiencePlayer_AdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        AudiencePlayer_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        AudiencePlayer_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        AudiencePlayer_AdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'AudiencePlayer_AdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
    ...
    abstract class AudiencePlayer_AdminPageFramework_Utility_VariableType extends AudiencePlayer_AdminPageFramework_Utility_Deprecated {
    ...
    abstract class AudiencePlayer_AdminPageFramework_Utility_String extends AudiencePlayer_AdminPageFramework_Utility_VariableType {
    ...
    abstract class AudiencePlayer_AdminPageFramework_Utility_Array extends AudiencePlayer_AdminPageFramework_Utility_String {
    ...
    abstract class AudiencePlayer_AdminPageFramework_Utility_ArrayGetter extends AudiencePlayer_AdminPageFramework_Utility_Array {
        ...
        static public function getArrayValueByArrayKeys($aArray, $aKeys, $vDefault = null) {
            ...
            if (isset($aArray[$_sKey])) {
                if (empty($aKeys)) {
                    return is_string($aArray[$_sKey]) ? \sanitize_text_field($aArray[$_sKey]) : $aArray[$_sKey];
                }
    ...
    abstract class AudiencePlayer_AdminPageFramework_Utility_ArraySetter extends AudiencePlayer_AdminPageFramework_Utility_ArrayGetter {
    ...
    abstract class AudiencePlayer_AdminPageFramework_Utility_Path extends AudiencePlayer_AdminPageFramework_Utility_ArraySetter {
    ...
    abstract class AudiencePlayer_AdminPageFramework_Utility_URL extends AudiencePlayer_AdminPageFramework_Utility_Path {
    ...
    abstract class AudiencePlayer_AdminPageFramework_Utility_File extends AudiencePlayer_AdminPageFramework_Utility_URL {
    ...
    abstract class AudiencePlayer_AdminPageFramework_Utility_SystemInformation extends AudiencePlayer_AdminPageFramework_Utility_File {
    ...
    abstract class AudiencePlayer_AdminPageFramework_Utility_HTMLAttribute extends AudiencePlayer_AdminPageFramework_Utility_SystemInformation {
    ...
    class AudiencePlayer_AdminPageFramework_Utility extends AudiencePlayer_AdminPageFramework_Utility_HTMLAttribute {
