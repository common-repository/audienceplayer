...
class AudiencePlayer_AdminPageFramework_FrameworkUtility extends AudiencePlayer_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = AudiencePlayer_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return AudiencePlayer_AdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
    }
    class AudiencePlayer_AdminPageFramework_ArrayHandler extends AudiencePlayer_AdminPageFramework_FrameworkUtility {
        public $aData = array();
