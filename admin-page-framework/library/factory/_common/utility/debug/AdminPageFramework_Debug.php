...
class AudiencePlayer_AdminPageFramework_Debug_Base extends AudiencePlayer_AdminPageFramework_FrameworkUtility {
    ...
    class AudiencePlayer_AdminPageFramework_Debug_Log extends AudiencePlayer_AdminPageFramework_Debug_Base {
    ...
    class AudiencePlayer_AdminPageFramework_Debug extends AudiencePlayer_AdminPageFramework_Debug_Log {
        ...
        static public function dumpArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('AudiencePlayer_AdminPageFramework_Debug::' . __FUNCTION__, 'AudiencePlayer_AdminPageFramework_Debug::dump()');
            AudiencePlayer_AdminPageFramework_Debug::dump($asArray, $sFilePath);
        }
        static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
            self::showDeprecationNotice('AudiencePlayer_AdminPageFramework_Debug::' . __FUNCTION__, 'AudiencePlayer_AdminPageFramework_Debug::get()');
            return AudiencePlayer_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
        }
        static public function logArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('AudiencePlayer_AdminPageFramework_Debug::' . __FUNCTION__, 'AudiencePlayer_AdminPageFramework_Debug::log()');
            AudiencePlayer_AdminPageFramework_Debug::log($asArray, $sFilePath);
        }
        static public function getAsString($mValue) {
            self::showDeprecationNotice('AudiencePlayer_AdminPageFramework_Debug::' . __FUNCTION__);
