...
abstract class AudiencePlayer_AdminPageFramework_Property_Base extends AudiencePlayer_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'audienceplayer' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aAudiencePlayer_AdminPageFramework'])) {
            $GLOBALS['aAudiencePlayer_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => AudiencePlayer_AdminPageFramework_Registry::NAME, 'sURI' => AudiencePlayer_AdminPageFramework_Registry::URI, 'sScriptName' => AudiencePlayer_AdminPageFramework_Registry::NAME, 'sLibraryName' => AudiencePlayer_AdminPageFramework_Registry::NAME, 'sLibraryURI' => AudiencePlayer_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => AudiencePlayer_AdminPageFramework_Registry::getVersion(), 'sDescription' => AudiencePlayer_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => AudiencePlayer_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => AudiencePlayer_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => AudiencePlayer_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => AudiencePlayer_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new AudiencePlayer_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
    }
