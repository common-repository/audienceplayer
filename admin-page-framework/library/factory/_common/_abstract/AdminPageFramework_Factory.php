...
abstract class AudiencePlayer_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'AudiencePlayer_AdminPageFramework_Form_', 'oPageLoadInfo' => 'AudiencePlayer_AdminPageFramework_PageLoadInfo_', 'oResource' => 'AudiencePlayer_AdminPageFramework_Resource_', 'oHelpPane' => 'AudiencePlayer_AdminPageFramework_HelpPane_', 'oLink' => 'AudiencePlayer_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'AudiencePlayer_AdminPageFramework_Debug', 'oUtil' => 'AudiencePlayer_AdminPageFramework_FrameworkUtility', 'oMsg' => 'AudiencePlayer_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(AudiencePlayer_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return AudiencePlayer_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
    ...
    abstract class AudiencePlayer_AdminPageFramework_Factory_Model extends AudiencePlayer_AdminPageFramework_Factory_Router {
        public function __construct($oProp) {
    ...
    abstract class AudiencePlayer_AdminPageFramework_Factory_View extends AudiencePlayer_AdminPageFramework_Factory_Model {
        public function __construct($oProp) {
            parent::__construct($oProp);
            new AudiencePlayer_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
        }
    ...
    abstract class AudiencePlayer_AdminPageFramework_Factory_Controller extends AudiencePlayer_AdminPageFramework_Factory_View {
    ...
    abstract class AudiencePlayer_AdminPageFramework_Factory extends AudiencePlayer_AdminPageFramework_Factory_Controller {
    }
