...
abstract class AudiencePlayer_AdminPageFramework_Input_Base extends AudiencePlayer_AdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'audienceplayer-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'audienceplayer-input-label-string',),);
    ...
    class AudiencePlayer_AdminPageFramework_Input_checkbox extends AudiencePlayer_AdminPageFramework_Input_Base {
