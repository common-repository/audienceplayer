...
class AudiencePlayer_AdminPageFramework_FieldType_radio extends AudiencePlayer_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".audienceplayer-field input[type='radio'] {margin-right: 0.5em;} .audienceplayer-field-radio .audienceplayer-input-label-container {padding-right: 1em;} .audienceplayer-field-radio .audienceplayer-input-container {display: inline;} .audienceplayer-field-radio .audienceplayer-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.audienceplayer-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).prop( 'checked', false );
