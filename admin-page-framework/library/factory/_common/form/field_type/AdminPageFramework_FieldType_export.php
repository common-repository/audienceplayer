...
class AudiencePlayer_AdminPageFramework_FieldType_submit extends AudiencePlayer_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".audienceplayer-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'audienceplayer-input-label-container' . ' audienceplayer-input-button-container' . ' audienceplayer-input-container',);
    }
    ...
    class AudiencePlayer_AdminPageFramework_FieldType_export extends AudiencePlayer_AdminPageFramework_FieldType_submit {
