...
class AudiencePlayer_AdminPageFramework_FieldType_import extends AudiencePlayer_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".audienceplayer-field-import input {margin-right: 0.5em;}.audienceplayer-field-import label,.form-table td fieldset.audienceplayer-fieldset .audienceplayer-field-import label { display: inline; }";
    }
