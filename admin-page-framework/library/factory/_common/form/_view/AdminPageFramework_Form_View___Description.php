...
class AudiencePlayer_AdminPageFramework_Form_View___Description extends AudiencePlayer_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'audienceplayer-form-element-description';
