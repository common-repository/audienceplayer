...
class AudiencePlayer_AdminPageFramework_Form_View___Attribute_SectionsTablesContainer extends AudiencePlayer_AdminPageFramework_Form_View___Attribute_Base {
    ...
    protected function _getAttributes() {
        return array('id' => $this->sSectionsID, 'class' => $this->getClassAttribute('audienceplayer-sections', $this->getAOrB(!$this->sSectionTabSlug || '_default' === $this->sSectionTabSlug, null, 'audienceplayer-section-tabs-contents'), $this->getAOrB(empty($this->aCollapsible), null, 'audienceplayer-collapsible-sections-content' . ' ' . 'audienceplayer-collapsible-content' . ' ' . 'accordion-section-content'), $this->getAOrB(empty($this->aSectionset['sortable']), null, 'sortable-section')), 'data-seciton_id' => $this->aSectionset['section_id'], 'data-section_address' => $this->aSectionset['section_id'], 'data-section_address_model' => $this->aSectionset['section_id'] . '|' . '___i___',) + $this->_getDynamicElementArguments($this->aSectionset);
    }
    private function _getDynamicElementArguments($aSectionset) {
        ...
        $_oSectionNameGenerator = new AudiencePlayer_AdminPageFramework_Form_View___Generate_SectionName($aSectionset, $aSectionset['_caller_object']->aCallbacks['hfSectionName']);
