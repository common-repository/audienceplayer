...
class AudiencePlayer_AdminPageFramework_Form_View___DebugInfo extends AudiencePlayer_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='audienceplayer-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
