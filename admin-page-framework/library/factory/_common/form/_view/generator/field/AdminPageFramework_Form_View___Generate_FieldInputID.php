...
class AudiencePlayer_AdminPageFramework_Form_View___Generate_FieldTagID extends AudiencePlayer_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
    ...
    class AudiencePlayer_AdminPageFramework_Form_View___Generate_FieldInputID extends AudiencePlayer_AdminPageFramework_Form_View___Generate_FieldTagID {
        public $isIndex = '';
