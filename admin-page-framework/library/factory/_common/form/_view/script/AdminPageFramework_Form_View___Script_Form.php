...
class AudiencePlayer_AdminPageFramework_Form_View___Script_Form extends AudiencePlayer_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removeAudiencePlayer_AdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.audienceplayer-form-loading' ).remove();
        jQuery( '.audienceplayer-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.audienceplayer-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removeAudiencePlayer_AdminPageFrameworkLoadingOutputs();
