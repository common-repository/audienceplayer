...
class AudiencePlayer_AdminPageFramework_Form_View___Script_SectionTab extends AudiencePlayer_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.audienceplayer-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='audienceplayer-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
