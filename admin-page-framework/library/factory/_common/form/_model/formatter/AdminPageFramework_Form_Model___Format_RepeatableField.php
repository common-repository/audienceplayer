...
class AudiencePlayer_AdminPageFramework_Form_Model___Format_RepeatableSection extends AudiencePlayer_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : AudiencePlayer_AdminPageFramework_Message::getInstance();
    }
    public function get() {
    ...
    class AudiencePlayer_AdminPageFramework_Form_Model___Format_RepeatableField extends AudiencePlayer_AdminPageFramework_Form_Model___Format_RepeatableSection {
        protected function _getDefaultMessage() {
