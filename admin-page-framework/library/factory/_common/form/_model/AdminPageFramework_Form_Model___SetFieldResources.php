...
class AudiencePlayer_AdminPageFramework_Form_Model___SetFieldResources extends AudiencePlayer_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new AudiencePlayer_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('AudiencePlayer_AdminPageFramework_Form_View___CSS_Form', 'AudiencePlayer_AdminPageFramework_Form_View___CSS_Field', 'AudiencePlayer_AdminPageFramework_Form_View___CSS_Section', 'AudiencePlayer_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'AudiencePlayer_AdminPageFramework_Form_View___CSS_FieldError', 'AudiencePlayer_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('AudiencePlayer_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new AudiencePlayer_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new AudiencePlayer_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
