...
class AudiencePlayer_AdminPageFramework_Property_post_meta_box extends AudiencePlayer_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'audienceplayer', $sStructureType = 'post_meta_box') {
