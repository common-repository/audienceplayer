...
abstract class AudiencePlayer_AdminPageFramework_MetaBox_Router extends AudiencePlayer_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'audienceplayer') {
    ...
    abstract class AudiencePlayer_AdminPageFramework_MetaBox_Model extends AudiencePlayer_AdminPageFramework_MetaBox_Router {
        public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'audienceplayer') {
        ...
        public function _replyToGetSavedFormData() {
            $_oMetaData = new AudiencePlayer_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
            $this->oProp->aOptions = $_oMetaData->get();
            return parent::_replyToGetSavedFormData();
        }
        private function _getPostID() {
            if (isset($GLOBALS['post']->ID)) {
                return intval($GLOBALS['post']->ID);
            }
            if (isset($_GET['post'])) {
    ...
    abstract class AudiencePlayer_AdminPageFramework_MetaBox_View extends AudiencePlayer_AdminPageFramework_MetaBox_Model {
    ...
    abstract class AudiencePlayer_AdminPageFramework_MetaBox_Controller extends AudiencePlayer_AdminPageFramework_MetaBox_View {
    ...
    abstract class AudiencePlayer_AdminPageFramework_MetaBox extends AudiencePlayer_AdminPageFramework_MetaBox_Controller {
