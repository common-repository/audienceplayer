...
class AudiencePlayer_AdminPageFramework_Property_page_meta_box extends AudiencePlayer_AdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'audienceplayer', $sStructureType = 'page_meta_box') {
        unset($this->oAdminPage, $this->aHelpTabs);
        parent::__construct($oCaller, $sClassName, $sCapability, $sTextDomain, $sStructureType);
        $GLOBALS['aAudiencePlayer_AdminPageFramework']['aMetaBoxForPagesClasses'] = $this->getElementAsArray($GLOBALS, array('aAudiencePlayer_AdminPageFramework', 'aMetaBoxForPagesClasses'));
        $GLOBALS['aAudiencePlayer_AdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array('aAudiencePlayer_AdminPageFramework', 'aPageClasses'));
