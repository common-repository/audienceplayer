...
abstract class AudiencePlayer_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('AudiencePlayer_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new AudiencePlayer_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
